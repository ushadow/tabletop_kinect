...
public class HeatMap extends JPanel {
  ...
  private static final long serialVersionUID = 6527754300402791601L;
  private double[][] data;
   ...
   * @param useGraphicsYAxis If true, the data will be displayed with the y=0
   *          row at the top of the screen. If false, the data will be displayed
   *          with they=0 row at the bottom of the screen.
   * @param colors A variable of the type Color[]. See also
  ...
  /**
   * Specify the coordinate bounds for the X Min. Only used for the axis labels,
   * which must be enabled seperately. Calls repaint() when finished.
   * 
   * @param xMin The lower bound of x-values, used for axis labels
   */
  ...
  /**
   * Specify the coordinate bounds for the X Max. Only used for the axis labels,
   * which must be enabled seperately. Calls repaint() when finished.
   * 
   * @param xMax The upper bound of x-values, used for axis labels
   */
  ...
  /**
   * Specify the coordinate bounds for the Y Min. Only used for the axis labels,
   * which must be enabled seperately. Calls repaint() when finished.
   * 
   * @param yMin The lower bound of Y-values, used for axis labels
   */
  ...
  private void updateDataColors() {
    ...
    logger.fine(String.format("largest = %f, smallest = %f", largest, smallest));
  ...
  /**
   * This function generates data that is not vertically-symmetric, which makes
   * it very useful for testing which type of vertical axis is being used to
   * plot the data. If the graphics Y-axis is used, then the lowest values
   * should be displayed at the top of the frame. If the non-graphics
   ...
   * @param useGraphicsYAxis If true, the data will be displayed with the y=0
   *          row at the top of the screen. If false, the data will be displayed
   *          with the y=0 row at the bottom of the screen.
   */
  ...
  public void paintComponent(Graphics g) {
    ...
    // axis ticks - ticks start even with the bottom left coner, end very close
    // to end of line (might not be right on)
    ...
    // X-Axis ticks
    if (drawXTicks) {
      int xDist = (int) ((width - 60) / (double) numXTicks); // distance between
                                                             // ticks
